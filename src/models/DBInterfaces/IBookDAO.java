...
public interface IBookDAO {
	...
	void addBook(Book book, long authorId, long categoryId) throws SQLException, AlreadyExistException ;
	...
	boolean isExist(String title, long authorId) throws SQLException;
}
